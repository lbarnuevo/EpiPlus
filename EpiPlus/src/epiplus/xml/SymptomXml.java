...
public class SymptomXml {

	// Create .xml file from java file

	public static void symptom2Xml(Symptom symptom) throws JAXBException {
		...
		File file = new File("./xmls/External-Symptom.xml");
	...
	public static Symptom xml2Symptom() throws JAXBException {
		...
		File file = new File("./xmls/External-Symptom.xml");
		Symptom symptom = (Symptom) unmarshaller.unmarshal(file);
